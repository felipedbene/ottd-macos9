...
bool ReadLanguagePack(const LanguageMetadata *lang)
{
	...
	const char *c_file = (strrchr(_current_language->file, PATHSEPCHAR) ? strrchr(_current_language->file, PATHSEPCHAR) + 1 : _current_language->file);
 ...
 */
void CheckForMissingGlyphs_R1UNUSED(bool base_font, MissingGlyphSearcher *searcher)
{
